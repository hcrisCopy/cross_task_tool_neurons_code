...
DEFAULT_ACTIVATIONS_DIR = "../cross_task_tool_neurons_data/tool_knowledge_neurons/activations"
...
def main() -> None:
    ...
    print("ToolKnowledgeNeurons TKN-4 delegates to PreciseShield FFN intermediate activation extraction.")
