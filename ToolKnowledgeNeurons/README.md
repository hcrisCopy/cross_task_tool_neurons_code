...
这相当于把 PreciseShield 的大模型 FFN-intermediate 神经元定义、deepfake-code 的平行样本 paired shift、Safety Kernel 的跨任务共享方向一致性合在一起。后续 PP-1/PP-2 完全沿用 ProbePrefill 的二分类 probe 训练方法，不改训练细节。
