...
STAGE4_LAUNCHER = REPO_ROOT / "PreciseShield" / "ps_run_activation_extraction.py"
DEFAULT_ACTIVATIONS_DIR = "../cross_task_tool_neurons_data/precise_shield_deepfake/activations"
...
def main() -> None:
    ...
    print("PreciseShield_Deepfake PSDF-4 delegates to PreciseShield FFN intermediate activation extraction.")
