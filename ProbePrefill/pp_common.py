...
PROBE_METHOD_CONFIGS = {
    ...
    PROBE_METHOD_PRECISE_SHIELD_DEEPFAKE: {
        "namespace": "precise_shield_deepfake",
        "label": "PreciseShield_Deepfake",
        "shared_label": "PSDF_CTD",
        "single_label": "PSDF_TDN",
        "shared_filename": "PSDF_CTD_neurons.jsonl",
        "single_filename": "PSDF_TDN_neurons.jsonl",
        "feature_set": "PSDF_CTD",
        "feature_description": "PreciseShield_Deepfake shared FFN intermediate paired-shift neurons",
        "feature_definition": "PSDF-4 last-input-token FFN intermediate h before down_proj restricted to PSDF-6 A/B/C intersection neurons scored by Deepfake paired_shift_score",
    ...
    PROBE_METHOD_TOOL_KNOWLEDGE_PATHWAYS: {
        ...
        "shared_label": "TKP_TKN_CTD",
        "single_label": "TKN_TDN",
        "shared_filename": "TKP_TKN_CTD_neurons.jsonl",
        "single_filename": "TKN_TDN_neurons.jsonl",
        "feature_set": "TKP_TKN_CTD",
        "feature_description": "ToolKnowledgePathways directional skip-layer TKN pathway neurons",
        "feature_definition": (
            "TKP-1 last-input-token FFN intermediate h before down_proj restricted to "
            "pathway-enhanced TKN neurons: per-layer tool_high/direct_high TKN anchors plus "
            "directional skip-layer coactivation nodes with sampled masking validation"
        ),
        "train_probe_method": "TKP_TKN_CTD logistic probe",
        "probe_prefill_method": "ToolKnowledgePathways-TKP_TKN_CTD-Probe&Prefill",
    },
    PROBE_METHOD_TOOL_ROUTING_NEURONS: {
    ...
    PROBE_METHOD_TOOL_CIRCUIT_NEURONS: {
        "namespace": "tool_circuit_neurons",
        "label": "ToolCircuitNeurons",
        "shared_label": "TCN_CTD",
        "single_label": "TCN_TDN",
        "shared_filename": "TCN_CTD_neurons.jsonl",
        "single_filename": "TCN_TDN_neurons.jsonl",
        "feature_set": "TCN_CTD",
        "feature_description": "ToolCircuitNeurons fused FFN-output, FFN-intermediate, and attention-routing shared neurons",
        "feature_definition": (
            "TCN-1 concatenated ProbePrefill features from ToolDecisionAnchors TDA_CTD, "
            "ToolKnowledgeNeurons TKN_CTD, and ToolRoutingNeurons TRN_CTD, after exact train/test id alignment"
        ),
        "train_probe_method": "TCN_CTD logistic probe",
        "probe_prefill_method": "ToolCircuitNeurons-TCN_CTD-Probe&Prefill",
    },
}
PP_SUBDIRS = {
...
def normalize_probe_method(value: str | None) -> str:
    ...
    aliases = {
        ...
        "psdf": PROBE_METHOD_PRECISE_SHIELD_DEEPFAKE,
        "ps_deepfake": PROBE_METHOD_PRECISE_SHIELD_DEEPFAKE,
        ...
        "tool_knowledge_pathways": PROBE_METHOD_TOOL_KNOWLEDGE_PATHWAYS,
        "tkp_tkn": PROBE_METHOD_TOOL_KNOWLEDGE_PATHWAYS,
        "tkp_tkn_ctd": PROBE_METHOD_TOOL_KNOWLEDGE_PATHWAYS,
        ...
        "tcn": PROBE_METHOD_TOOL_CIRCUIT_NEURONS,
        "toolcircuitneurons": PROBE_METHOD_TOOL_CIRCUIT_NEURONS,
        "tool_circuit_neuron": PROBE_METHOD_TOOL_CIRCUIT_NEURONS,
        "tool_circuit_neurons": PROBE_METHOD_TOOL_CIRCUIT_NEURONS,
        "tcn_ctd": PROBE_METHOD_TOOL_CIRCUIT_NEURONS,
    }
...
def default_method_activations_dir(probe_method: str | None) -> Path:
    ...
    if method == PROBE_METHOD_TOOL_CIRCUIT_NEURONS:
        return data_root() / "tool_circuit_neurons" / "activations"
...
def default_method_neurons_dir(probe_method: str | None) -> Path:
    ...
    if method == PROBE_METHOD_PRECISE_SHIELD_DEEPFAKE:
        return data_root() / "precise_shield_deepfake" / "neurons"
    ...
    if method == PROBE_METHOD_TOOL_CIRCUIT_NEURONS:
        return data_root() / "tool_circuit_neurons" / "neurons"
