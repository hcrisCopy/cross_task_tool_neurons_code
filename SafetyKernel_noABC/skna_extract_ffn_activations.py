...
DEFAULT_ACTIVATIONS_DIR = "../cross_task_tool_neurons_data/safety_kernel_noabc/activations"
...
def main() -> None:
    ...
    print("SafetyKernel_noABC SKNA-4 delegates to the shared Safety Kernel FFN activation extractor.")
